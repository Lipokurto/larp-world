...
export const assWin04: Item = {
  label: 'Захватить казну',
  element:
    <>
      <h3>Эффект:</h3>
        <div>Атакующие получают все деньги лагеря и с бойцов поверженных</div>
      <h3>Условия</h3>
        <div>Все павшие бойцы и жители лагеря должны быть обысканы</div>
      ...
      <h3>Действия защитников:</h3>
        <div>Все защитники лагеря и его жители, которые находились в лагере во время штурма обязаны сдать все деньги</div>
        <div>Интендант лагеря сдает все деньги из казны лагеря</div>
        <div>игровые предметы остаются не тронутыми</div>
