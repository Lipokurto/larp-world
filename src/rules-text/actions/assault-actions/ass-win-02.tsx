...
export const assWin02: Item = {
  ...
  element:
    <>
      ...
      <h3>Условия</h3>
        <div>Все жители лагеря, находящиеся внутри вов ремя штурма, должны быть пленены или добиты</div>
      ...
      <h3>Действия защитников:</h3>
        ...
        <div>Все игровые предметы, находящиеся внутри лагеря, и казная остаются не тронутыми</div>
