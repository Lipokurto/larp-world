  ...
  element:
    <>
      ...
      <ol className={s.listContainer}>
        ...
        <li>Выдается некоторое количество карт в колоду известности артиста.</li>
      </ol>
      <div>ПРИМЕЧАНИЕ: Публичные выступление – единственный способ пополнить колоду известности артиста.</div>
    </>
}