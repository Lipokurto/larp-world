  ...
  element:
    <>
      ...
      <ol className={s.listContainer}>
        ...
        <li>Если игрок имел карту <b>"Метка жертвы"</b>, то чудовище должен выдать карту <b>"Сожран"</b> и чудовище получает <b>2</b> карты <b>"Череп"</b>.</li>
      </ol>
      <div>Дополнительно: Пленники чудовища никогда не выживают и не имеют возможности бежать.</div>
    </>
}