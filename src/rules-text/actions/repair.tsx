  ...
  element:
    <>
      ...
      <ol className={s.listContainer}>
        ...
        <li>Игрок восстанавливается все броневые хиты.</li>
        <li>Игрок выходит из статуса <b>"Ремонт"</b> (снимает соответствующую повязку).</li>
      </ol>
      ...
      <div className={s.listContainer}>
        ...
        <li><b>Швы без обработки:</b>  Игрок значительно удалился от кузницы. Игрок прерывает ремонт и ему придется начинать его сначала.</li>
      </div>
