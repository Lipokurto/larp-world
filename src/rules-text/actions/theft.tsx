  ...
  element:
    <>
      ...
      <ol className={s.listContainer}>
        ...
        <li>Наличие таких карт в ДК игрока не делает его вором.</li>
        <li>Карты воровства, которые не использованы, но могут быть использованы игроков в будущем храниться исключительно в ДК, чтоб их нельзя было спутать с примененными картами</li>
      ...
      <ol className={s.listContainer}>
        ...
        <li>В случае обнаружения такой карты мастерский торговец просит показать игровые ресурсы из ДК, и забирает тот который считает нужным.</li>
