...
export const rest: Item = {
  ...
  element:
    <>
      ...
      <div>Персонаж может посетить увеселительное заведение с целью снять текущий стресс и немного расслабиться.</div>
      ...
      <ol className={s.listContainer}>
        ...
        <li>Артист предлагает вытянуть карту из своей колоды известности.</li>
      ...
      <div className={s.label}><i>Дополнительно</i></div>
      <ol className={s.listContainer}>
        <li>Исповедь можно заменить различным видом отыгрыша на усмотрение и инквизитора, например, показательная порка, изгнание дьявола, пытки злых духов, испытание веры, чтение молитв и т.д.</li>
