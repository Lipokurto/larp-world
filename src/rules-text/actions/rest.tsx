  ...
  element:
    <>
      ...
      <ol className={s.listContainer}>
        ...
        <li>После обсуждения цены и спектра предоставляемых услуг, персонаж сдает свой паспорт игрока хозяину заведения.</li>
      ...
      <ol className={s.listContainer}>
        ...
        <li>Выбранная карта кладется персонажу-просителю в паспорт игрока.</li>
      </ol>

      <div className={s.label}><i>Дополнительно</i></div>
      <ol className={s.listContainer}>
        <li>Артист может сам себе восстанавливать рассудок, вытягивая из своей колоды артиста нужные карты.</li>
        <li>Выбранные карты кладутся персонажу в паспорт игрока, покидая колоду артиста.</li>
