...
export const prisoner: Item = {
  ...
  element: (
    <>
      ...
      <div>Хранится в паспорте игрока, передается только между игроком и интендантом, как доказательство того что игрок может продолжить играть без отсидки мертвяка.</div>
