export const battle = {
  chapter: 'Боевые взаимодействия',
  rules: [
    {
      label: 'Правила по допуску оружию',
      text: [
    ...
    },
    {
      ...
      text: [
        ...
        <h4>Восстановление броне хитов</h4>,
        <div><b>Доспехи обычного качества</b></div>,
        <div>Если были сняты не все броне хиты</div>,
          <li>При помощи “Смазки доспеха” (смазка - ресурс который можно приобрести у алхимика или обменять в лагере очки влияния ) Отыгрывается осмотром и смазкой доспехов, при этом флакон с маслом тратится окончательно</li>,
        ...
        <div>Если сняты ВСЕ броне хиты:</div>,
          <li>Чинится ремкомплектом</li>,
          <li>Перековывается у кузнеца</li>,
          <li>Нельзя починить “Оружейным маслом”</li>,
        <br />,
        <div><b>Доспехи хорошего качества</b></div>,
          <li>В любом состоянии может чиниться “Оружейным маслом”</li>,
        <br />,
        ...
        <div>Восстанавливаются броневые хиты:</div>,
          <li>Кузница</li>,
          <li>Ремкомплект</li>,
          <li>Оружейное масло</li>,
          <li>Мертвяк</li>,
      ]
    },
    {
      label: 'Медицина и лечение',
      text: [
      ...
      <br />,
      <div>Для лечения легкого ранения медкомлпектом:</div>,
        <li>На медкомплекте ломается печать</li>,
        <li>Внутри медкомплекта находятся: бинт, лоскут ткани, игла, нить</li>,
        <li>Раненая конечность перевязывается</li>,
      ...
      <div><b>ПРИМЕЧАНИЕ:</b> Использованный медкомплект можно продать мастерам</div>,
      <br />,
      <div>Лечение легкого ранения при помощи <button onClick='#click#'>зелья лечения</button>:</div>,
