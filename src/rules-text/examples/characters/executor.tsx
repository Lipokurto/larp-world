  ...
  element: 
    <>      
      ...
      <div className={s.listContainer}>
        ...
        <li>В случае получения психоза заменяет ее на психоз "Фанатик"</li>
        <li>В свите инквизитора не более 2 палачей</li>
      </div>
      ...
      <div className={s.listContainer}>
        ...
        <li>На фазе проектирования рекомендуется согласовать концепт оружия с хронистами</li>
      </div>
