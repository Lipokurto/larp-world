...
export const bag: Item = {
  ...
  element: 
    <>
      ...
      <div>Заплечная корзина для одиночного ношения</div>
      ...
      <div className={s.listContainer}>
        ...
        <li>На каждую сумку выдается специальный паспорт с количеством предметов которые она может переносить. Предметы хранятся в этом паспорте</li>
