export const explainRepair = {
  ...
  text: 
    <>
      ...
      <li><b>Ремокомплект:</b> одноразовый, можно применять самостоятельно, тратит время, имеет вес, но позволяет отремонтировать броню даже из сломанного состояния без кузница</li>
