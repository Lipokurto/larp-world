...
export const ancestors: Item = {
  ...
  element:
    <>      
      ...
      <div><b>Отношение к меткам:</b> Метка позволяет попасть в вальхаллу, где предки будут биться с тобой вечность бок о бок против неиссякаемых орд противников</div>
