...
import pdfRules from '../../rules-text/Pravila_Temnye_veka_v_1_2.pdf';
  ...
  const renderLinks = React.useMemo(() => {
    return (
      <>
        ...
        <Tooltip
          content='Все правила одним файлом PDF (v1-2)'
          background='wheat'
          direction="left"
        >
          <a href={pdfRules} target='_blank' rel="noreferrer" style={{color: 'goldenrod'}} download={'Темные_века_правила_v1-2'}>
