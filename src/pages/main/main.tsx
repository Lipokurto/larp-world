...
import pdfRules from '../../rules-text/Pravila_Temnye_veka_v_2_3_0.pdf';
  ...
  const renderLinks = React.useMemo(() => {
    return (
      <>
        ...
        <Tooltip
          content='Все правила одним файлом PDF (v2-3-0)'
          background='wheat'
          direction="left"
        >
          <a href={pdfRules} target='_blank' rel="noreferrer" style={{ color: 'goldenrod' }} download={'Темные_века_правила_v2-3-0'}>
