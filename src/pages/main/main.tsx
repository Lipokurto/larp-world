...
import pdfRules from '../../rules-text/Pravila_Temnye_veka_v_1_17_1.pdf';
  ...
  const renderLinks = React.useMemo(() => {
    return (
      <>
        ...
        <Tooltip
          content='Все правила одним файлом PDF (v1-17-1)'
          background='wheat'
          direction="left"
        >
          <a href={pdfRules} target='_blank' rel="noreferrer" style={{color: 'goldenrod'}} download={'Темные_века_правила_v1-17-1'}>
