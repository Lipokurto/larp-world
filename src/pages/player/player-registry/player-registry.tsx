...
const registrationSteps: Steps[] = [
  ...
  },
  {
    ...
    description: 
      <div>
        <div>Составьте заявку согласно шаблону:</div>
        
        <div className={s.request}>
          <div><b>ФИО: </b><i>Свое реальной ФИО</i></div>
  ...
  },
  {
    ...
    description:
      <div>
        ...
        <div>Отправьте фото своего полного костюма в "Сообщениях группы" с указанием своего ФИО</div>
        <div>Дождитесь подтверждения или комментария о возможных участках доработки</div>
      </div>
  },
  {
    img: donation,
    ...
    description:
      <div>
        ...
        <div><i>реквизиты будут указаны позже</i></div>
      </div>
  },
]
