...
const registrationSteps: Steps[] = [
  {
    ...
    description: (
      <div>
        ...
        <div>Ознакомьтесь с <a href='https://docs.google.com/spreadsheets/d/10qtHRKDqcJN79-8Ef9Kjys25EFVoEp_bvDABDTudrRA/edit?usp=sharing' target='_blank' rel="noreferrer" style={{ color: 'goldenrod' }}>таблицей ролей</a></div>
      </div>
    ),
  },
  {
    ...
    description: (
      <div>
        ...
        <div className={s.request}>
          ...
          <div><b>Локация: </b><i>Название лагеря или района города</i></div>
          <div><b>Возраст: </b><i>Полных лет на момент начала мероприятия</i></div>
        </div>
        ...
        <div>Если ваша заявка принята - вам сообщат о создании личного кабинета, используя который вы можете следить за статусом своей заявки</div>
        <br />
