  ...
  return (
    <>
      <div className={s.container}>
        ...
        <div>Каждый игрок на данном мероприятии должен иметь роль. В случае, если игрок при регистрации не соответствует требованиям выбранной роли МГ оставляет за собой право на наложение игрового штрафа, недопуск на заявленную роль с предложением замены роли или полный недопуск на проект данного игрока. Мера будет избираться в зависимости от степени несоответствия костюма заявленной роли.</div>
