  ...
  return (
    <>
      <div className={s.container}>
        ...
        />
        <br />
        <div><i>На игре паралельно оригинальной боевой системе можно использовать и классическую хитовую систему боевых взаимодействий, но с некоторыми изменениями</i></div>
        <div><i>О том какая система боевых взаимодейсвтий сейчас используется игроком свидетельствует соотвествующая печать в паспорте игрока</i></div>
        <div><i>Сменить боевую систему можно после выхода из мертвяка</i></div>
        <AccordionBlock
          label='Классическая система'
          items={[
            {
              label: 'Хиты персонажа - классика',
              element:
                <>
                  ...
                  <div className={s.sub_container}>
                    ...
                    <LinkButton text='Примеры отсутсвия брони' onclick={() => handleClick(noArmor)}/>
                    <div>Всего у падобного персонажа 1 хит, тот который начисляется со старта</div>
                    <h3>Легкий доспех</h3>
                    <LinkButton text='Примеры легкой брони' onclick={() => handleClick(lightArmor)}/>
            ...
            {
              label: 'Лечение - классика',
              element:
                <>
                  <div>Если игроку сняли последний хит то он переходит в состоание "тяжело ранен", из которого его можно вывести только лечением</div>
                  <h3>Для лечения ранения в госпитале</h3>
                  <li>К перевязке крепится значек "лечится" на котором указывается: кто перевязал и когда необходимо снять перевязку</li>
            ...
            {
              label: 'Урон оружия - классика',
              element:
                <>
                  <div><b>Все оружие ближнего боя:</b> снимает 1 хит</div>
                  <div><b>Оружие дальнего боя:</b> снимает 2 хита</div>
                  <div><b>Тяжелое огнестрельное оружие:</b> снимает все хиты, пробивает щиты</div>
                  <div><b>Особое оружие:</b> снимает все хиты, не пробивает щиты</div>
                </> 
            },
          ]}
        />
