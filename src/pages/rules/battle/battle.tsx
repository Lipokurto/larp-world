              ...
              element:
                <div className={s.zones}>
                  ...
                  <div className={s.zonesText}>
                    ...
                    <br />
                    <div>
                      Поражаемой зоной чудовищ считается вся передняя плоскость костюма. При этом костюмы должны быть выполнены таким образом, чтобы защитить все запрещенные к поражению зоны оператора с какой бы стороны не наносился урон.
                    </div>
                  </div>
                </div>
            },
              ...
              element:
                <>
                  ...
                  <div className={s.listContainer}>
                    ...
                    <li>Персонаж положил оружие на землю и поднял обе руки вверх.</li>
            ...
            },
            {
              ...
              element:
                <>
                  ...
                  <div><b>Пушка</b> снимает 10 хитов, пробивает щиты, может снимать очки прочности ворот.</div>
                </>
            },
            {
              label: 'Особое оружие',
