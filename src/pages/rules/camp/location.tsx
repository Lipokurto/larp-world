            ...
            element: (
              <>
                <div className={s.listContainer}>
                  ...
                  <div>Если у вас есть планы вывозить нечто отличное по конструкции с данными образцами - это следует оговорить с Хронистами</div>
                  <div>Основное правило 5 метров: ваше здание/шатер с расстояния 5 метров должны выглядеть как исторические аналоги</div>
