        ...
        items={[
          {
            ...
            element:
              <>
                ...
                <div className={s.listContainer}>
                  <li>В случае смерти человеческой формы игрок-чудовище обязан прибывать в монструозной форме 2 часа</li>
                ...
                <div className={s.listContainer}>
                  ...
                  <li>Если игрок погибает в монструозной форме - мертвяк составляет 3 часа</li>
                </div>
              </>
          },
          {
            ...
            element:
              <>
                ...
                <br />
                <div>Если игрок хочет пожрать человека “в поле” то он должен находится в монструозной форме, но чудовище может поедать жертв в свое лагере в человеческой форме</div>
