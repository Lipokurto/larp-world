          ...
          },
          {
            ...
            element:
              ...
              <div className={s.listContainer}>
                ...
                <li><b>Безвольный.</b> Чтоб одержимый вышел из мертвяка, необходимо чтобы чудовище-вожак пожертвовал хитами монструозной формы(5 хитов)</li>
                ...
                <li><b>Ведомый.</b> В случаем смерти чудовища-вожака, все его одержимые переходят в состояние "мертв"</li>
                <li><b>Дикая форма.</b> В случае если апостол в человеческой форме - одержимый может действовать на свое усмотрение в качестве полуразумного монстра. Для каждого дикого одержимого время мертвяка 30 минут без возможности лечения</li>
              </div>
              </>
          },
          {
