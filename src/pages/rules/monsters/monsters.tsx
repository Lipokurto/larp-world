          ...
          },
          {
            ...
            element:
              ...
              <div className={s.listContainer}>
                ...
                <li><b>Дикая форма.</b> В случае если апостол в человеческой форме, то одержимый может действовать на свое усмотрение в качестве полуразумного монстра, с временем мертвяка 30 минут и без возможности лечиться.</li>
              </div>
              </>
          },
          {
