            ...
            items={[
              {
                ...
                text: 
                  <>
                    ...
                    <div><LinkButton text='Постройки' onclick={() => handleClick(gather)} /></div>
                    <div>Каджая такая постройка производит один из двух ресурсов</div>
                    <div><LinkButton text='Лечебные травы' onclick={() => handleClick(herbs)} /></div>
                    <div><LinkButton text='Железная руда' onclick={() => handleClick(ore)} /></div>
                  </>
              },
              {
                label: 'Профелированные постройки',
                text: 
                  <>
                    <h4><LinkButton text='Гопиталь' onclick={() => handleClick(hospital)} /> производит <LinkButton text='медкомплект' onclick={() => handleClick(healPack)} /></h4>
                    <h4><LinkButton text='Кузница' onclick={() => handleClick(smith)} /> производит <LinkButton text='ремкомплект' onclick={() => handleClick(repairPack)} /></h4>
                    <h4><LinkButton text='Лаборатория' onclick={() => handleClick(alchemist)} /> производит <LinkButton text='целебную мазь' onclick={() => handleClick(healPotion)} /> и  производит <LinkButton text='оружейное масло' onclick={() => handleClick(repairPotion)} /></h4>
                  </>
              },
              {
                label: 'Эффективность постройки',
                text: 
                  <>
