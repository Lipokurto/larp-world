              ...
              },
              {
                ...
                element:
                  <>
                    ...
                    <h4>Таблица расчета времени производства</h4>
                    <TimeTable />
                  </>
              },
              {
                ...
                element:
                  <>
                    ...
                    <li><b>Можно прервать в любой момент:</b> Игрок должен иметь возможность прервать оказания услуг</li>
              ...
              items={[
                {
                  ...
                  element: 
                    <>
                      ...
                      <li>Пребывая в мертвяке игрок ОБЯЗАН носить на голове и на предплечье ЯРКО красную повязку и не иметь при себе оружия (повязки выдается при регистрации)</li>
                  ...
                  },
                  {
                    ...
                    element:
                      <>
                        ...
                        <li>Отсутствие стрелкового оружия</li>
                        <br />
                        <div>Ограничения:</div>
