              ...
              },
              {
                ...
                element:
                  <>
                    ...
                    <div className={s.label}>Бордель</div>
                    <div>Данное заведение стабильно платит инквизиции какую-то часть дохода, из-за чего инквизиция не лезет во внутренне дела предприятия</div>
                    <div>Для хорошей работы борделя надо придумать прикрытие, ибо негоже в открытую торговать услугами падших женщин</div>
                    <div>Чем благозвучнее прикрытие тем меньше вероятность что инквизиция вмешается в дела борделя</div>
                    <div>Отыгрыш секса: по желанию заведения</div>
                    <div>Основная прибыль: плата за информацию и клиентура</div>
                    <div className={s.label}>Рекрутер</div>
                    <div>Место где наемники-одиночки могут получать свои контракты, за выполнение которых положена награда</div>
                    <div className={s.label}>Игорный дом</div>
                    <div>Игроки играют в средневековые азартные игры, церковь конечно этого не ободряет</div>
                  </>
              },
              {
