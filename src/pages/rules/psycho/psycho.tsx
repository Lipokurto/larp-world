    ...
    <>
      <div className={s.container}>
        ...
        <div className={s.listContainer}>
          ...
          <div>Каждая последующая смерть добавляет вероятность получения психоза, к примеру умер второй раз то теперь для получения психоза достаточно выкинуть 1 или 2, умер третий раз - 1, 2, 3 и т.д.</div>
          <br />
