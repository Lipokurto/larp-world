  ...
  return (
    <div className={s.container}>
      ...
      <div className={s.block}>
        ...
        <div className={s.block2}>
          <h3>Урон чудовища</h3>
          <div>Урон чудовища можно разделить на три типа, каждый из которых однозначно определяется визуально:</div>
          <li><b>Клыки/рога/шипы/когти/щупальца.</b> Cнимает все бронированные хиты с участка брони в которую попали (не пробивает щиты)</li>
          <li><b>Метательное оружие.</b> Моделируется мягкой сферой диаметром не менее 5 см с подсветкой. При попадании в тело - снимает все живые хиты в обход брони. При попадании в щит, щит необходимо тут же отбросить</li>
          <li><b>Тяжелое оружие.</b> Моделируется гротескным вооружением, например, гигантская дубина/длинный двуручный меч/вырванное дерево и т.д. При попадании в тело - снимает все живые хиты в обход брони. При попадании в щит - снимает все живые хиты с руки которой тот держится</li>
        </div>
