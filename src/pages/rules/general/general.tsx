            ...
            items={[
              {
                ...
                element: 
                  <>
                    ...
                    <div>Любой мертвый игрок находящийся в мертвяке должен сдать интенданту или мастеру мертвяка свой ДК на время пребывания в мертвяке.</div>
                    ...
                    <div className={s.listContainer}>
                      ...
                      <li>Избавится от <b>"Метки жертвы"</b> можно только получив карту <b>"Сожран"</b> или <b>"Прощение"</b>(если не применялось действие <b>«Убить персонажа»</b> считается временной смертью).</li>
                      ...
                      <li>Если в ДК есть пометка о смерти с использованием особого действия «Убить персонажа», то игрок возвращается новым персонажем. Если такой пометки нет, то игрок, после отсидки положенного срока мертвяка, возвращается тем же персонажем, но не помнит ничего, что касалось его «временной» смерти.</li>
                    ...
                    <div className={s.listContainer}>
                      ...
                      <li>В случае если чудовище находиться в человеческой форме, то одержимые принимают <b>«Дикую форму»</b>.</li>
                    </div>
                  </>
              },
              {
