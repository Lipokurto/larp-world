            ...
            items={[
              {
                ...
                element: 
                  <>
                    ...
                    <div>Время пребывания в мертвяке <b>2 часа</b>.</div>
                    ...
                    <div className={s.listContainer}>
                      ...
                      <li>Если в паспорт игрока есть пометка о смерти с использованием особого действия «Убить персонажа», то игрок возвращается новым персонажем. Если такой пометки нет, то игрок, после отсидки положенного срока мертвяка, возвращается тем же персонажем, но не помнит ничего, что касалось его «временной» смерти.</li>
