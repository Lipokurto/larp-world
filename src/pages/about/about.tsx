  ...
  return (
    <div className={s.container}>
      ...
      <div className={s.listContainer}>
        <div>Название: <b>Темные века: Парад теней</b></div>
        <div>Дата: <b>30.09-03.10 2026</b></div>
      ...
      <div className={s.listContainer}>
        <div><b>Вторник (29.09):</b> Заезд на полигон, установка локаций, предварительная регистрация, семинары</div>
        <div><b>Среда (30.09):</b> Регистрация, начало мероприятия</div>
        <div><b>Четверг (01.10):</b> Полный игровой день. Боевка дневная и вечерняя</div>
        <div><b>Пятница (02.10):</b> Полный игровой день. Боевка дневная и вечерняя</div>
        <div><b>Суббота (03.10):</b> Игровой день до полудня. После полудня торги и вечерняя битва. Финальное построение</div>
        <div><b>Воскресенье (04.10):</b> Сбор лагерей, сдача локаций, уборка полигона, разъезд</div>
      </div>
