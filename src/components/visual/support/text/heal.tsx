        ...
        items={[
          {
            ...
            element:
              <>
                ...
                <div>Чтоб восстановить живой хит надо использовать "медкомплект" или "целебную мазь"</div>
                <div>
          ...
          },
          {
            ...
            element:
              <>
                <div>Исходя из брони вашего персонажа, сверх живого хита вам начисляются бронированные хиты</div>
      ...
      <AccordionBlock
        ...
        items={[
          ...
          },
          {
            ...
            element:
              <>
                <div>Все игровые предметы и деньги являются пробираемыми, поэтому аккуратно рассчитывайте что брать с собой</div>
              </>
          },
          {
            label: 'Зелья',
            element:
              <>
                <div>Зелья обладают р ядом преимуществ перед комплектами, но вероятнее всего будут стоить дороже</div>
              </>
          },
        ]}
      />
