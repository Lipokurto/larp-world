  ...
  element:
    <>
      <div className={s.container}>
        ...
        <div>
          <NavLink replace to='/help/build-calc' onClick={() => document.body.style.overflowY = 'visible'} style={{color: 'goldenrod'}}>Расчёт эффективности постройки</NavLink>
        </div>
      </div>
      ...
      <AccordionBlock
        ...
        items={[
          ...
          },
          {
            ...
            element:
              <>
                <div>Производственные постройки создают игровые ресурсы отыгрышем и временем</div>
              </>
          },
          {
            label: 'Услуги',
            element:
              <>
                <div>Услуги игрового характера предоставляются за игровые и не могут давать никаких игровых преимуществ, кроме как развлечения</div>
              </>
          },
        ]}
      />
        ...
        items={[
          {
            ...
            element:
              <>
                ...
                <div>Кабак легко может ввести абонементы</div>
          ...
          },
          {
            ...
            element:
              <>
                <div>Если вы торгуете реальным товаром, то учитывайте что на игре обмен реальными деньгами и продажа запрещены</div>
