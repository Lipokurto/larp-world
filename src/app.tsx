...
import {
  PlayerRegistry, TeamRegistry, BuildingRegistry,
} from './pages/player';
    ...
    <BrowserRouter>
      <div className={s.app}>
        ...
        <Route path="/auth/callback" element={<AuthCallback />} />
          ...
          <Route path='/world/cities' element={<Cities />} />
          ...
          <Route path='/player/regbuild' element={<BuildingRegistry />} />
          <Route path='/player/regpay' element={<PayRegistry />} />

          <Route path='/about' element={<About />} />
          <Route path='/more' element={<More />} />
          <Route path='/vk-policy' element={<Conf />} />
          <Route path='/user' element={user?.id ? <UserPage vkId={user?.id}/> : <UserEmptyPage />} />
        </Routes>
      </div>
    </BrowserRouter>
  );
